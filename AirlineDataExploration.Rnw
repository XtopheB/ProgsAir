...
% 09/05/2013 : Nouveaux graphiques et test de M et alphe...
...
p<-qplot(y.c, score.m.cont, data=score.m.cont, geom=c("boxplot"), 
      fill=y.c, main="Airlines efficiency on contemporaneous order-m frontier",
...
p <- qplot(y.c, score.alpha.cont, data=score.alpha.cont, geom=c("boxplot"), 
      fill=y.c, main="Airlines efficiency on contemporaneous alpha frontier",
